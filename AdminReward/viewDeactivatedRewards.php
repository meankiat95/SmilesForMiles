...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1 class="font-weight-light text-center text-lg-left mt-4 mb-0">Deactivated [Rewards]</h1>
            ...
            <div class="row text-center text-lg-left">
				...
				$result = listAllDeactivatedRewards();
                $count = 0;
                ...
                echo "<div class='col-lg-3 col-md-4 col-6'><form action='modifyDeactivatedRewards.php' method='post'> 
