            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <!-- Page Content -->
                    ...
                    <div class="container">
                        ...
                        <br>
						<form name="myForm" action="modifyRewardFunct.php" method="post" enctype="multipart/form-data">
						...
						<button type="submit" name="submit" value="deactivate" class="btn btn-danger">Deactivate</button>
